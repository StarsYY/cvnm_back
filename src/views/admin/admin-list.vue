<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.introduction" maxlength="20" :placeholder="$t('table.introduction')" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
